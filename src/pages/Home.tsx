...
// Auth import removed for Clerk integration
...
export function Home() {
  // Auth usage removed for Clerk integration
  ...
  const totalPeople = categories.reduce((acc, category) => acc + category.people.length, 0);
  const totalSamples = categories.reduce(
    (acc, category) => 
      acc + category.people.reduce((personAcc, person) => personAcc + person.sampleCount, 0), 
    0
  );
  ...
  // Render backend status indicator at the bottom of the page
  const BackendStatus = () => {
    return (
      <div className="fixed bottom-4 right-4 p-2 rounded-lg shadow-md z-50">
        {backendStatus === 'connecting' && (
          <div className="flex items-center bg-yellow-100 text-yellow-800 px-3 py-1 rounded">
        ...
        {backendStatus === 'error' && (
          <div className="flex items-center bg-red-100 text-red-800 px-3 py-1 rounded">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 p-6 rounded-xl shadow-sm border border-blue-100">
              ...
              <p className="text-gray-600">Access to {!isLoading ? totalPeople : '...'} personalities with {!isLoading ? totalSamples : '...'} voice samples</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-xl shadow-sm border border-blue-100">
              <div className="bg-blue-100 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                ...
                >
                  <div className="p-4">
                    ...
                    <Link to="/access" className="block text-center mt-3 text-sm text-blue-600 hover:text-blue-800 font-medium">
                      View All
                    </Link>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div className="p-4">
                    ...
                    <Link to="/access" className="block text-center mt-3 text-sm text-purple-600 hover:text-purple-800 font-medium">
                      View All
                    </Link>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div className="p-4">
                    ...
                    <Link to="/access" className="block text-center mt-3 text-sm text-green-600 hover:text-green-800 font-medium">
                      View All
                    </Link>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div className="p-4">
                    ...
                    <Link to="/access" className="block text-center mt-3 text-sm text-red-600 hover:text-red-800 font-medium">
                      View All
                    </Link>
                  </div>
                </div>
