...
export function Dashboard() {
  ...
  // State to track if this is the first visit after subscribing
  const [showWelcome, setShowWelcome] = useState(true);
  
  // Check if user came from subscription page
  useEffect(() => {
    // Check local storage for a flag indicating they just subscribed
    const justSubscribed = sessionStorage.getItem('justSubscribed') === 'true';
    setShowWelcome(justSubscribed);
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-28 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-800"
          />
          {searchQuery && (
            <button 
